    ...
    <div class="flex items-center justify-center min-h-screen">
      <div class="max-w-7xl mx-auto mt-8 mb-8 bg-gray-900 p-8 rounded-lg shadow-lg w-full">
        ...
        <section>
          ...
          <!-- Si no hay juegos -->
          <div v-else-if="catPs5.length === 0" class="text-center text-white">
...
import LoadingScreen from '@/components/LoadingScreen.vue' // Asegúrate de que la ruta es correcta

// Lista de productos y estado de carga
const catPs5 = ref([])
